...
class MoveTool extends TransformationTool
{
  ...
  constructor(application, options)
  {
    super(application);
    this.name = "move";
    this.label = "design|tool.move.label";
    this.className = "move";
    this.iconName = "design|move";
  ...
  setStage(stage)
  {
    ...
    switch (stage)
    {
      case 0: // set anchor point
        ...
        I18N.set(this.helpElem, "textContent", "design|tool.move.select_anchor_point");
      ...
      case 1: // set destination point
        ...
        this.buttonsPanel.style.display = "none";
        I18N.set(this.helpElem, "textContent", "design|tool.move.select_destination_point");
        application.i18n.update(this.helpElem);
        break;
      ...
      case 2: // set distance
        ...
        I18N.set(this.helpElem, "textContent", "design|tool.move.edit_offset");
        application.i18n.update(this.helpElem);
        break;
    }
  }
