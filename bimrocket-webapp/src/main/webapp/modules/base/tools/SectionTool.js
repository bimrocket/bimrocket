...
import { GestureHandler } from "platform/ui/GestureHandler.js";
...
class SectionTool extends Tool
{
  constructor(application, options)
  {
    super(application);
    this.name = "section";
    this.label = "base|tool.section.label";
    this.className = "section";
    this.iconName = "base|section";
    ...
    const url = $url("../assets/textures/section.png", import.meta);
  ...
  createPanel()
  {
    ...
    this.planeTypeSelectElem = Controls.addSelectField(this.panel.bodyElem,
      "section_planes", "base|label.plane",
      [["z_min", "base|tool.section.z_min"],
       ["z_max", "base|tool.section.z_max"],
       ["x_center", "base|tool.section.x_center"],
       ["y_center", "base|tool.section.y_center"]]);
    ...
    this.planeTypeSelectElem.parentElement.className = "mt-1";
    ...
    this.sectionColorElem = Controls.addColorField(this.panel.bodyElem,
      "section_color", "base|label.section_color");
    this.sectionColorElem.parentElement.className =
      "flex align-items-center justify-center mt-1";
    ...
    this.offsetElem.className = "flex align-items-center justify-center mt-1";
  ...
  updatePanel()
  {
    ...
    if (application.renderer.localClippingEnabled)
    {
      ...
      I18N.set(this.helpElem, "textContent", "base|tool.section.offset_plane");
    }
    else
    {
      this.offsetElem.style.display = "none";
      this.planeTypeSelectElem.parentElement.style.display = "";
      I18N.set(this.helpElem, "textContent", "base|tool.section.select_plane");
    }
