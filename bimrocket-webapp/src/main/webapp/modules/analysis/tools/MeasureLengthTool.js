...
class MeasureLengthTool extends Tool
{
  constructor(application, options)
  {
    ...
    this.label = "analysis|tool.measure_length.label";
    this.className = "measure-length";
    this.iconName = "analysis|measure-length";
  ...
  createPanel()
  {
    ...
    I18N.set(this.helpElem, "textContent", "analysis|tool.measure_length.help");
