...
class DrawTool extends Tool
{
  constructor(application, options)
  {
    super(application);
    this.name = "draw";
    this.label = "design|tool.draw.label";
    this.help = "design|tool.draw.help";
    this.className = "draw";
    this.iconName = "design|draw";
  ...
  createPanel()
  {
    ...
    I18N.set(this.helpElem, "textContent", "design|tool.draw.help");
    ...
    this.finishButton = Controls.addButton(this.buttonsElem,
      "draw_finish", "design|button.finish", event => this.finish());

    this.profileButton = Controls.addButton(this.buttonsElem,
      "draw_make_profile", "design|button.make_profile", event => this.makeProfile());
  ...
  updatePanel()
  {
    if (this.mode === 0)
    {
      ...
      {
        I18N.set(this.helpElem, "textContent", "design|tool.draw.first_vertex");
      }
      else
      {
        I18N.set(this.helpElem, "textContent", "design|tool.draw.add_vertex");
      }
    }
    else if (this.mode === 1)
    {
      if (this.index === -1)
      {
        I18N.set(this.helpElem, "textContent", "design|tool.draw.select_vertex");
      }
      else
      {
        I18N.set(this.helpElem, "textContent", "design|tool.draw.vertex_destination");
      }
    }
