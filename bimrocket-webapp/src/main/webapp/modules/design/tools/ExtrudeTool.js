...
class ExtrudeTool extends Tool
{
  constructor(application, options)
  {
    super(application);
    this.name = "extrude";
    this.label = "design|tool.extrude.label";
    this.className = "extrude";
    this.iconName = "design|extrude";
  ...
  setStage(stage)
  {
    ...
    switch (stage)
    {
      case 0: // set depth value
        ...
        I18N.set(this.helpElem, "textContent", "design|tool.extrude.drag_pointer");
      ...
      case 2: // no object selected
        ...
        I18N.set(this.helpElem, "textContent", "design|tool.extrude.select_object");
        application.i18n.update(this.helpElem);
        this.removeExtrusionAxis();
        break;
    }
