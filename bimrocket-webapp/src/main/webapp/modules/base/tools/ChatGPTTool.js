...
class ChatGPTTool extends Tool
{
  ...
  constructor(application, options)
  {
    super(application);
    this.name = "chatgpt";
    this.label = "base|tool.chatgpt.label";
    this.className = "chatgpt";
    this.iconName = "base|assistant";
  ...
  createPanel()
  {
    this.panel = this.application.createToolPanel(this)
      .setPosition("center")
      .setClassName("panel-chatgpt")
      .setDefaultHeight(240)
      .setDefaultMobileHeight(220)
    ...
    this.ellipsisElem.classList.add("ellipsis-loading");
    ...
    this.deleteButton = Controls.addButton(this.footerElem,
      ...
      ConfirmDialog.create("base|title.delete_conversation",
       "base|question.delete_conversation")
