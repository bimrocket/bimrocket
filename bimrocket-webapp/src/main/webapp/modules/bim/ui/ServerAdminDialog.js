...
class ServerAdminDialog extends Dialog
{
  ...
  {
    super(options.title || "bim|title.server_admin");
    ...
    const mainContainer = this.createContainer('admin-panel', this.bodyElem);
    const connPanel = this.createContainer('admin-body', mainContainer);
    const mainWrapper = this.createContainer('admin-panel', this.bodyElem);
    const mainPanel = this.createContainer('admin-body', mainWrapper);
    ...
    const buttonsContainer = this.createContainer('admin-buttons', connPanel);
    this.connButtonsElem = buttonsContainer;

    // hidden initially
    this.detailPanelElem = this.createContainer('admin-panel', mainContainer);
  ...
  createTab(container, tabClassName, toolbarClassName, buttonId, buttonLabel,
    buttonCallback, tabContainerProperty, toolbarProperty, tableContainerProperty)
  {
    ...
    this[tableContainerProperty].className = "table-container";
  ...
  createUserSearchPanel()
  {
    ...
    this.searchToolbar.className = "search-panel";
    ...
    this.searchBody.className = "admin-body";
  ...
  createRoleSearchPanel()
  {
    ...
    this.roleSearchToolbar.className = "search-panel";
    ...
    this.roleSearchBody.className = "admin-body";
  ...
  createUserForm()
  {
    if (!this.detailPanelElem)
    {
      ...
      this.detailPanelElem.className = "admin-panel";
      this.detailPanelElem.style.display = "none";
    }
    ...
    this.detailButtonsElem.className = "admin-buttons";
  ...
  createRoleForm()
  {
    ...
    this.roleDetailPanelElem.className = "admin-panel";
    ...
    this.roleDetailButtonsElem.className = "admin-buttons";
  ...
  showUser(user = null)
  {
    ...
    this.updateFields([
      ...
      { field: this.passwordField, value: "", placeholder: isCreation ?
        "" : this.application.i18n.get("bim|placeholder.keep_password"), required: isCreation },
      { field: this.passwordConfirmField, value: "", placeholder: isCreation ?
        "" : this.application.i18n.get("bim|placeholder.confirm_password"), required: isCreation }
    ]);
