...
class Tree
{
  constructor(parent)
  {
    ...
    parent.appendChild(this.rootsElem);
...
class TreeNode
{
  constructor(tree, parentTreeNode, value, action, className, hasChildren)
  {
    ...
    this.nodeElem.tabIndex = 0;
    this.itemElem.appendChild(this.nodeElem);
  ...
  get linkElem()
  {
    console.warn("deprecated TreeNode.linkEm: use nodeElem instead");
  ...
  addEventListener(type, listener)
  {
    this.nodeElem.addEventListener(type, listener);
  }

  removeEventListener(type, listener)
  {
    this.nodeElem.removeEventListener(type, listener);
  }
  ...
  addClass(className)
  {
    this.nodeElem.classList.add(className);
  }

  removeClass(className)
  {
    this.nodeElem.classList.remove(className);
  }
  ...
  updateLabel()
  {
    ...
    if (label instanceof HTMLElement)
    {
      ...
      this.nodeElem.appendChild(label);
    }
    else
    {
      ...
      {
        I18N.set(this.nodeElem, "textContent", label);
      }
      else
      {
        this.nodeElem.textContent = label;
      }
    }
  }
  ...
  expandAncestors(makeVisible = false)
  {
    ...
    if (makeVisible)
    {
      this.nodeElem.scrollIntoView({ block: "center", inline: "nearest"});
    }
  }
  ...
  addExpandButton()
  {
    if (this.buttonElem === null)
    {
      ...
      this.itemElem.insertBefore(this.buttonElem, this.nodeElem);
      this.itemElem.classList.add("collapsed");
    }
  }
  ...
  addElement(element)
  {
    this.nodeElem.appendChild(element);
  }
  ...
  addChildrenList()
  {
    if (this.childrenElem === null)
    {
      ...
      this.itemElem.classList.add("hc");
    }
  }
  ...
  removeChildrenList()
  {
    ...
    this.itemElem.classList.remove("hc");
    this.childrenElem = null;
  }
}
