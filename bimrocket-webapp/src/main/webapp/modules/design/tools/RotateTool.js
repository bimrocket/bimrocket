...
class RotateTool extends TransformationTool
{
  ...
  constructor(application, options)
  {
    super(application);
    this.name = "rotate";
    this.label = "design|tool.rotate.label";
    this.className = "rotate";
    this.iconName = "design|rotate";
    ...
    switch (stage)
    {
      case 0: // set first point of rotation axis
        ...
        I18N.set(this.helpElem, "textContent",
          "design|tool.rotate.select_first_point");
      ...
      case 1: // set second point of rotation axis
        ...
        this.buttonsPanel.style.display = "none";
        I18N.set(this.helpElem, "textContent",
          "design|tool.rotate.select_second_point");
        application.i18n.update(this.helpElem);
        break;
      ...
      case 2: // set anchor point
        ...
        this.buttonsPanel.style.display = "none";
        I18N.set(this.helpElem, "textContent",
          "design|tool.rotate.select_anchor_point");
        application.i18n.update(this.helpElem);
        break;
      ...
      case 3: // set destination point
        ...
        this.buttonsPanel.style.display = "none";
        I18N.set(this.helpElem, "textContent",
          "design|tool.rotate.select_destination_point");
        application.i18n.update(this.helpElem);
        break;
      ...
      case 4: // edit rotation angle
        ...
        I18N.set(this.helpElem, "textContent",
          "design|tool.rotate.edit_rotation");
        application.i18n.update(this.helpElem);
        break;
    }
  }
