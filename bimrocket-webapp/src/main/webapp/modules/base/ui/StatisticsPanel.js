...
class StatisticsPanel extends Panel
{
  constructor(application)
  {
    super(application);
    this.id = "statistics";
    this.title = "base|tool.statistics.label";
    this.position = "right";
    this.defaultHeight = 100;
    this.defaultMobileHeight = 100;
    ...
    var fpsPanel = new StatisticsPanel.Canvas("FPS", "#0ff", "#002");
    this.bodyElem.appendChild(fpsPanel.dom);

    var msPanel = new StatisticsPanel.Canvas("MS", "#0f0", "#020");
...
StatisticsPanel.Canvas = function (name, fg, bg)
{
