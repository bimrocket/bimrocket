...
class GLTFWriter {
    ...
    // bimrocket: replace ?. operator
		...
		const width = Math.max( metalness ? metalness.width || 0 : undefined,
                            roughness ? roughness.width || 0 : undefined);
		const height = Math.max( metalness ? metalness.height || 0 : undefined,
                             roughness ? roughness.height || 0 : undefined);
