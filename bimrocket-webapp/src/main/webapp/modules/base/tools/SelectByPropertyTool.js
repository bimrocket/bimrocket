...
class SelectByPropertyTool extends Tool
{
  constructor(application, options)
  {
    ...
    this.label = "base|tool.select_by_property.label";
    this.className = "select-by-property";
    this.iconName = "base|select-by-property";
    ...
    this.dialog = new PropertySelectorDialog(this.application,
      { title : "base|title.select_by_property",
        selectValues : true,
  ...
  selectObjects()
  {
    ...
    try
    {
      ...
      Toast.create("base|message.objects_selected_by_prop",
