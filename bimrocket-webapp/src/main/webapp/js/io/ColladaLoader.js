...
class ColladaLoader extends Loader {
	...
	parse( text, path ) {
		...
		if ( asset.upAxis === 'Y_UP' ) { // bimrocket: change Z_UP by Y_UP, change warn message.

			console.warn( 'THREE.ColladaLoader: You are loading an asset with a Y-UP coordinate system. The loader just rotates the asset to transform it into Z-UP. The vertex data are not converted, see #24289.' );
