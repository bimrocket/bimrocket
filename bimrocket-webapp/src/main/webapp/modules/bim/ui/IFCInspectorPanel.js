...
class IFCInspectorPanel extends Panel
{
  constructor(application)
  {
    super(application);
    this.id = "bim_inspector";
    this.title = "bim|tool.ifc_inspector.label";
    this.position = "left";
    this.iconName = "bim|ifc-inspector";
    this.setClassName("ifc-inspector-panel");
    ...
    this.helpElem.classList.add("mb-4");

    this.tabbedPane = new TabbedPane(this.bodyElem);
    this.tabbedPane.paneElem.classList.add("ifc-inspector-tabs");
