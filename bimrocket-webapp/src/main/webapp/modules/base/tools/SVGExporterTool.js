...
class SVGExporterTool extends Tool
{
  constructor(application, options)
  {
    ...
    this.label = "base|tool.svg_exporter.label";
    this.className = "svg-export";
    this.iconName = "base|svg-export";
  ...
  createPanel()
  {
    ...
    this.titleElem = Controls.addTextField(this.panel.bodyElem,
      "svg_exporter_title", "base|label.svg_exporter_title", "", "row");

    this.scaleElem = Controls.addTextField(this.panel.bodyElem,
      "print_scale", "base|label.print_scale", "10", "row");
