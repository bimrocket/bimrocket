...
class ScaleTool extends TransformationTool
{
  ...
  constructor(application, options)
  {
    super(application);
    this.name = "scale";
    this.label = "design|tool.scale.label";
    this.className = "scale";
    this.iconName = "design|scale";
  ...
  createPanel()
  {
    ...
    this.scaleInputElem = Controls.addNumberField(this.panel.bodyElem,
      "scale_factor", "design|label.scale_factor", 1);
    ...
    this.lengthInputElem = Controls.addNumberField(this.panel.bodyElem,
      "scale_length", "design|label.length", 0);
    ...
    this.keepPropCheckbox = Controls.addCheckBoxField(this.panel.bodyElem,
      "scale_keep_prop", "design|label.scale_keep_proportions",
      this.keepProportions);
    ...
    switch (stage)
    {
      case 0: // set origin
        ...
        I18N.set(this.helpElem, "textContent",
          "design|tool.scale.select_first_point");
      ...
      case 1: // set anchor point
        ...
        this.buttonsPanel.style.display = "none";
        I18N.set(this.helpElem, "textContent",
          "design|tool.scale.select_anchor_point");
        application.i18n.update(this.helpElem);
        break;
      ...
      case 2: // set destination point
        ...
        this.buttonsPanel.style.display = "none";
        I18N.set(this.helpElem, "textContent",
          "design|tool.scale.select_destination_point");
        application.i18n.update(this.helpElem);
        break;
