...
class PropertySelectorDialog extends Dialog
{
  ...
  {
    super(options.title || "base|title.property_selector");
    ...
    this.mainElem.className = "property-selector";
    ...
    I18N.set(this.treeLabel, "textContent", options.treeLabel ||
      "base|label.selection_by_properties");
    ...
    this.toolBarElem.className = "property-toolbar";
