...
class SearchTool extends Tool
{
  constructor(application, options)
  {
    super(application);
    this.name = "search";
    this.label = "analysis|tool.search.label";
    this.className = "search";
    this.iconName = "analysis|search";
  ...
  createPanel()
  {
    ...
    this.textInput = Controls.addInputField(this.panel.bodyElem,
      "text", "text_to_find", "analysis|label.text_to_find");

    this.searchByNameCheckbox = Controls.addCheckBoxField(this.panel.bodyElem,
      "search_by_name", "analysis|label.search_by_name", true, "field-row");

    this.searchByValueCheckbox = Controls.addCheckBoxField(this.panel.bodyElem,
      "search_by_value", "analysis|label.search_by_value", true, "field-row");

    this.caseSensitiveCheckbox = Controls.addCheckBoxField(this.panel.bodyElem,
      "case_sensitive", "analysis|label.case_sensitive", false, "field-row");
  ...
  search()
  {
    ...
    if (matchCount === 0)
    {
      I18N.set(this.messageElem, "textContent", "analysis|message.no_matches");
    ...
    else
    {
      if (matchCount === 1)
      {
        I18N.set(this.messageElem, "textContent", "analysis|message.one_match");
        this.matchingsElem.style.display = "none";
      }
      else
      {
        I18N.set(this.messageElem, "textContent",
          "analysis|message.matches_count", matchCount);
      }
