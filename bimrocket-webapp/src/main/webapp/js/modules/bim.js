...
import { ModelValidationTool } from "../tools/ModelValidationTool.js";
...
export function load(application)
{
  ...
  const modelValidationTool = new ModelValidationTool(application);
  ...
  bimMenu.addMenuItem(modelValidationTool);
