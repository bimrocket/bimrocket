...
class IFCDBPanel extends Panel
{
  constructor(application)
  {
    ...
    // connect panel
    this.bodyElem.classList.add("ifcdb-panel");
    ...
    this.ifcdbServiceElem.parentElement.className = "ifcdb-field";
    ...
    this.connButtonsElem.className = "ifcdb-buttons";
    ...
    this.modelNameFilterElem.parentElement.className = "ifcdb-field";
    ...
    modelButtonsElem.className = "ifcdb-buttons";
    ...
    commandPanelElem.className = "ifcdb-command";
    ...
    commandButtonsElem.className = "ifcdb-buttons";
    ...
    this.resultElem.className = "ifcdb-result";
    ...
    this.modelIdElem = Controls.addTextField(this.modelPanelElem,
      "ifc_modelid", "bim|label.ifcdb_modelid", null, "ifcdb-field");
    this.modelIdElem.readOnly = true;

    this.modelNameElem = Controls.addTextField(this.modelPanelElem,
      "ifc_modelname", "bim|label.ifcdb_modelname", null, "ifcdb-field");

    this.modelDescElem = Controls.addTextAreaField(this.modelPanelElem,
      "ifc_modeldesc", "bim|label.ifcdb_modeldesc", null, "flex flex-column p_4");
    ...
    modelFooterPanelElem.className = "ifcdb-buttons";
