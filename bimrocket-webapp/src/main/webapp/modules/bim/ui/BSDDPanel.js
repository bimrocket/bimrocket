...
class BSDDPanel extends Panel
{
  ...
  constructor(application)
  {
    ...
    this.dictFilterElem = Controls.addInputField(this.dictPanelElem,
      "text", "bsdd_dict", "bim|label.bsdd_filter", null, "field-flex");
    ...
    this.dictContentElem.className = "text-left";
    ...
    this.classFilterElem = Controls.addInputField(this.classPanelElem,
      "text", "bsdd_class", "bim|label.bsdd_filter", null, "field-flex");
    ...
    this.classContentElem.className = "text-left";
