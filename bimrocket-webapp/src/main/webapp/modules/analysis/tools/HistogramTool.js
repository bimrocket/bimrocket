...
class HistogramTool extends Tool
{
  constructor(application, options)
  {
    super(application);
    this.name = "histogram";
    this.label = "analysis|tool.histogram.label";
    this.className = "histogram";
    this.iconName = "analysis|histogram";
  ...
  createPanel()
  {
    ...
    this.psetSelect = Controls.addSelectField(this.panel.bodyElem,
      "pset", "analysis|label.property_set");
    ...
    this.propertySelect = Controls.addSelectField(this.panel.bodyElem,
      "property", "analysis|label.property");
    ...
    this.groupSelect = Controls.addSelectField(this.panel.bodyElem,
      "round", "analysis|label.group_by",
      [["0", "analysis|option.no_groups"], "0.001", "0.01", "0.1", "1", "10", "100"]);
    ...
    this.sortSelect = Controls.addSelectField(this.panel.bodyElem,
      "sortBy", "analysis|label.order_by",
      [["va", "analysis|option.value_asc"],
       ["vd", "analysis|option.value_desc"],
       ["oa", "analysis|option.occurrences_asc"],
       ["od", "analysis|option.occurrences_desc"]]);
    ...
    this.highlightSelect = Controls.addSelectField(this.panel.bodyElem,
      "highlight", "analysis|label.highlight",
      [["N", "analysis|option.highlight_disabled"],
       ["R", "analysis|option.highlight_random_colors"],
       ["G", "analysis|option.highlight_color_grading"]]);
    ...
    this.showUndefinedCheckbox = Controls.addCheckBoxField(this.panel.bodyElem,
      "showUndefined", "analysis|label.show_undefined", false, "field-row");
  ...
  generateHistogram()
  {
    ...
    for (let i = 0; i < totalValues; i++)
    {
      ...
      if (highlight === "R" || highlight === "G")
      {
        ...
        bulletElem.className = "item-bullet";
      ...
      contentElem.className = "item-cnt";
      ...
      if (value === undefined)
      {
        I18N.set(valueElem, "textContent", "analysis|label.undefined");
