...
class PaintTool extends Tool
{
  constructor(application, options)
  {
    super(application);
    this.name = "paint";
    this.label = "design|tool.paint.label";
    this.className = "paint";
    this.iconName = "design|paint";
  ...
  createPanel()
  {
    ...
    this.materialUsageButton = Controls.addButton(this.panel.bodyElem,
      "material_usage", "design|button.material_usage",
      () => this.materialUsage());

    this.colorElem = Controls.addColorField(this.panel.bodyElem,
      "material_color", "design|label.color", null, "field-row inline");
    ...
    this.specularElem = Controls.addColorField(this.panel.bodyElem,
      "material_specular", "design|label.specular", null, "field-row inline");
    ...
    this.emissiveElem = Controls.addColorField(this.panel.bodyElem,
      "material_specular", "design|label.emissive", null, "field-row inline");
    ...
    this.opacityElem.className = "field-row";
    ...
    I18N.set(this.opacityLabel, "textContent", "design|label.opacity", 50);
    ...
    this.opacityRange.addEventListener("input", () =>
    {
      ...
      I18N.set(this.opacityLabel, "textContent",
    ...
    this.sideSelect = Controls.addSelectField(this.panel.bodyElem,
      "material_side", "design|label.material_side",
      [[String(THREE.FrontSide), "design|label.front_side"],
       [String(THREE.BackSide), "design|label.back_side"],
       [String(THREE.DoubleSide), "design|label.double_side"]],
      null, "field-row inline");
    ...
    this.depthTestCheckBox = Controls.addCheckBoxField(this.panel.bodyElem,
      "depth_test", "design|label.depth_test", false, "field-row");
    ...
    this.depthWriteCheckBox = Controls.addCheckBoxField(this.panel.bodyElem,
      "depth_write", "design|label.depth_write", false, "field-row");
    ...
    this.restoreMaterialsButton = Controls.addButton(this.applyElem,
      "restore_material", "design|button.restore_materials",
  ...
  newMaterial()
  {
    const dialog = new InputDialog(this.application,
      "design|title.new_material", "design|label.material_name", "");
  ...
  renameMaterial()
  {
    ...
    {
      const dialog = new InputDialog(this.application,
        "design|title.rename_material", "design|label.material_name",
        material.name);
      dialog.onAccept = name =>
      {
        material.name = name;
