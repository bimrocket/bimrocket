...
class ActiveMenuItem extends BaseMenuItem
{
  constructor(container, label)
  {
    ...
    // icon
    this.iconElement = Controls.addIcon(this.buttonElement, null, "icon");
...
class MenuItem extends ActiveMenuItem
{
  constructor(container, action)
  {
    ...
    const iconName = action.getIconName();
    if (iconName)
    {
      Controls.setIcon(this.iconElement, iconName);
    }
  }
...
class Menu extends MenuItemList(ActiveMenuItem)
{
  constructor(container, label)
  {
    ...
    this.togglerIconElement = Controls.addIcon(this.buttonElement,
      "chevron-right", "icon-toggler");
...
class BackMenuItem extends ActiveMenuItem
{
  constructor(container, label)
  {
    ...
    Controls.setIcon(this.iconElement, "chevron-left");
  }
...
{
  constructor(application, parent = document.body)
  {
    super(application);
    ...
    this.dropButtonElement.className = "menu-button";
    ...
    parent.appendChild(this.dropButtonElement);
...
class ContextMenu extends MenuItemContainer
{
  ...
  {
    await IconManager.updateTree(this.menuElement);
