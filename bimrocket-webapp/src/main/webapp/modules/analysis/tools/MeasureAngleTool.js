...
class MeasureAngleTool extends Tool
{
  constructor(application, options)
  {
    ...
    this.label = "analysis|tool.measure_angle.label";
    this.className = "measure-angle";
    this.iconName = "analysis|measure-angle";
  ...
  updateAngle()
  {
    ...
    if (this.vertices.length === 0)
    {
      I18N.set(this.helpElem, "textContent",
        "analysis|tool.measure_angle.select_first_point");
      I18N.set(this.angleElem, "textContent", "");
    }
    else if (this.vertices.length === 1)
    {
      I18N.set(this.helpElem, "textContent",
        "analysis|tool.measure_angle.select_second_point");
      I18N.set(this.angleElem, "textContent", "");
    }
    else if (this.vertices.length === 2)
    {
      I18N.set(this.helpElem, "textContent",
        "analysis|tool.measure_angle.select_third_point");
      I18N.set(this.angleElem, "textContent", "");
    }
    else if (this.vertices.length === 3)
    {
      ...
      I18N.set(this.angleElem, "textContent",
        "analysis|message.measure_angle", deg);
    }
