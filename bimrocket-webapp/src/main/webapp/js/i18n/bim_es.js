...
export const translations =
{
  ...
  "tool.model_validation.label" : "Vistas de Modelo",
  "tool.model_validation.help"  : "Vistas de Modelo — pinta elementos del modelo por valores de propiedades",
  ...
  "mv.title.file_browser"  : "Archivos Vistas de Modelo",
  ...
  "mv.btn.add_rule"           : "+ Regla (legado)",
  "mv.btn.add_stylization"    : "+ Regla",
  "mv.btn.add_value"          : "+ Valor",
  "mv.tree.add_condition"     : "+ Condición",
  "mv.tree.add_group"         : "+ Subcondición",
  "mv.tree.remove_condition"  : "Eliminar condición",
  "mv.tree.remove_group"      : "Eliminar subcondición",
  "mv.tree.type.and"          : "Y (AND)",
  "mv.tree.type.or"           : "O (OR)",
  "mv.tree.type.not"          : "NO (NOT)",
  "mv.styl.if"                : "SI",
  "mv.styl.then"              : "ENTONCES",
  ...
  "mv.placeholder.rule_name"    : "Nombre de la regla (opcional)...",
  ...
  "mv.filter.gt"           : "> Mayor que",
  "mv.filter.gte"          : ">= Mayor o igual que",
  ...
  "mv.action.color"        : "Colorear",
  "mv.action.transparent"  : "Transparente",

  "mv.opacity.fixed"       : "Fijo",
  "mv.opacity.property"    : "Propiedad",

  "mv.placeholder.pset"    : "Conjunto de propiedades",
  "mv.placeholder.param"   : "Parámetro",
  ...
  "mv.legend.filters"      : "Filtros",
  "mv.legend.select_all_pack" : "Seleccionar todos los objetos que coinciden con esta regla",
  "mv.legend.no_value"     : "— (sin valor)",
  "mv.legend.no_match"     : "✗ Sin coincidencia",

  "mv.match.has_param"     : "tiene parámetro",
  "mv.match.no_param"      : "sin parámetro",
  "mv.match.has_value"     : "tiene valor",
  "mv.match.no_value"      : "sin valor",
  "mv.match.exact"         : "igual a",
  "mv.match.contains"      : "contiene",
  "mv.match.starts"        : "empieza por",
  "mv.match.ends"          : "termina en",
  "mv.match.not_exact"     : "distinto de",
  "mv.match.not_contains"  : "no contiene",
  "mv.match.not_starts"    : "no empieza por",
  "mv.match.not_ends"      : "no termina en",
  "mv.match.gt"            : ">",
  "mv.match.gte"           : ">=",
  "mv.match.lt"            : "<",
  "mv.match.lte"           : "<=",
  ...
  "mv.dialog.save_title"   : "Guardar Vista de Modelo",
  ...
  "mv.action.save_here"    : "Guardar Vista de Modelo aquí",
  "mv.toast.navigate_to_save" : "Navega a la carpeta de destino y haz clic derecho para guardar la Vista de Modelo.",
  "mv.action.create"       : "Vistas de Modelo",
  "mv.action.edit"         : "Editar Vista de Modelo",
  "mv.error.not_model_validation" : "Este archivo no fue creado con el asistente de Vistas de Modelo.",
};
