...
import { ContextMenu } from "platform/ui/menu/Menu.js";
...
class BCFPanel extends Panel
{
  constructor(application)
  {
    ...
    this.searchPanelElem.id = "bcf-search-panel";
    this.searchPanelElem.className = "bcf-panel";
    this.bodyElem.appendChild(this.searchPanelElem);

    // connect panel

    this.connPanelElem = document.createElement("div");
    this.connPanelElem.className = "bcf-body";
    ...
    this.connButtonsElem.className = "bcf-buttons";
    ...
    this.filterProjectsElem.className = "bcf-body";
    ...
    this.filterVisibilityButton = Controls.addCheckBoxField(this.filterProjectsElem,
      "filterProjects", "bim|button.filter_projects", false, "bcf-checkbox");
    ...
    this.filterPanelElem.className = "bcf-body";
    this.filterPanelElem.style.display = "none";
    ...
    this.filterButtonsElem.className = "bcf-buttons";
    ...
    this.detailPanelElem.id = "bcf-detail-panel";
    this.detailPanelElem.className = "bcf-panel";
    ...
    this.previousTopicButton = Controls.addIconButton(this.topicNavElem,
      "previousTopic", "", "chevron-left", () => this.showPreviousTopic());
    this.previousTopicButton.className = "topic-nav-button previous";
    ...
    this.topicSearchIndexElem.className = "ml-1 mr-1";

    this.nextTopicButton = Controls.addIconButton(this.topicNavElem,
      "nextTopic", "", "chevron-right", () => this.showNextTopic());
    this.nextTopicButton.className = "topic-nav-button next";
    ...
    this.descriptionElem = Controls.addTextAreaField(this.detailBodyElem,
      "description", "bim|label.description", null, "bcf-description");

    this.detailButtonsElem = document.createElement("div");
    this.detailButtonsElem.className = "bcf-buttons";
    ...
    this.tabbedPane.paneElem.classList.add("bcf-tabs");
    ...
    this.viewpointListElem.classList = "bcf-list";
    ...
    this.auditPanelElem.classList.add("bcf-body");
    ...
    this.selectedComponentsElem.className = "selected-components";
    this.auditPanelElem.appendChild(this.selectedComponentsElem);

    // setup panel

    this.setupPanelElem = document.createElement("div");
    this.setupPanelElem.id = "bcf-config-panel";
    this.setupPanelElem.className = "bcf-panel";
    ...
    this.projectSetupElem.className = "bcf-project-setup";
    this.setupPanelElem.appendChild(this.projectSetupElem);

    this.extensionsSetupElem = document.createElement("div");
    this.extensionsSetupElem.className = "bcf-extensions-setup";
    ...
    this.projectButtonsElem.className = "bcf-buttons";
    ...
    this.saveExtensionsButtonsElem.className = "bcf-buttons";
  ...
  populateViewpointList(event)
  {
    ...
    for (let viewpoint of viewpoints)
    {
      ...
      Controls.addIcon(itemListHeaderElem, "bim|bcf-viewpoint");
      ...
      Controls.addTextWithArgs(itemListHeaderElem, "bim|message.viewpoint",
        [(viewpoint.index || ""), vpType], "bcf-viewpoint-text");

      Controls.addButton(itemListHeaderElem, "showViewpoint", "button.view",
        () => this.showViewpoint(viewpoint), "bcf-show-viewpoint");

      Controls.addButton(itemListHeaderElem, "deleteViewpoint", "button.delete",
        () =>
        {
      ...
      if (viewpoint.components && viewpoint.components.selection)
      {
        ...
        let componentsLabel = Controls.addLink(componentsContainer,
          ...
          "bim|title.select_components", "select-components",
          (event) =>
          {
            event.preventDefault();
      ...
      if (viewpoint.snapshot)
      {
        ...
        let linkElem = Controls.addLink(itemListElem, null, "#",
          "bim|label.zoom_image", "viewpoint-snapshot",
          () => this.zoomSnapshot(source));

        let imageElem = document.createElement("img");
        imageElem.className = "viewpoint-snapshot";
  ...
  populateCommentList()
  {
    ...
    for (let comment of comments)
    {
      ...
      Controls.addIcon(itemListHeaderElem, "bim|bcf-comment");
      ...
      Controls.addText(itemListHeaderElem, authorDate, "bcf-comment-author");
      ...
      Controls.addText(itemListElem, comment.comment, "bcf-comment-text");
      this.application.i18n.updateTree(itemListElem);
  ...
  populateDocumentReferenceList()
  {
    ...
    for (let docRef of docRefs)
    {
      ...
      Controls.addIcon(itemListHeaderElem, "bim|bcf-document");

      let linkElem = document.createElement("a");
      linkElem.href = docRef.url;
      linkElem.target = "_blank";
      linkElem.textContent = docRef.description;
      itemListHeaderElem.appendChild(linkElem);

      Controls.addButton(itemListHeaderElem, "updateDocRef", "button.edit",
        () => this.editDocumentReference(docRef),
        "bcf-edit-doc-ref");
      Controls.addButton(itemListHeaderElem, "deleteDocRef", "button.delete",
        () =>
        {
  ...
  zoomSnapshot(source)
  {
    ...
    dialog.setClassName("viewpoint-dialog");

    let imageElem = document.createElement("img");
    imageElem.className = "snapshot-zoom";
    imageElem.src = source;
    imageElem.onload = () =>
    {
