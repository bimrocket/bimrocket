...
class RevolveTool extends Tool
{
  constructor(application, options)
  {
    super(application);
    this.name = "revolve";
    this.label = "design|tool.revolve.label";
    this.className = "revolve";
    this.iconName = "design|revolve";
  ...
  createPanel()
  {
    ...
    this.changeAxisButton = Controls.addButton(this.buttonsElem,
      "revolve_changeAxis", "design|button.change_axis", event =>
    {
      this.angle = 0;
      this.updateRevolution();
      this.setStage(0);
    ...
    switch (stage)
    {
      case 0: // set revolve axis start point
        ...
        I18N.set(this.helpElem, "textContent",
          "design|tool.revolve.set_axis_first_point");
      ...
      case 1: // set revolve axis end point
        ...
        this.changeAxisButton.style.display = "none";
        I18N.set(this.helpElem, "textContent",
          "design|tool.revolve.set_axis_second_point");
        application.i18n.update(this.helpElem);
        this.removeWheel();
        break;
      ...
      case 2: // dynamic revolve: pointer up
        ...
        I18N.set(this.helpElem, "textContent",
          "design|tool.revolve.drag_pointer");
        application.i18n.update(this.helpElem);
        this.addWheel();
        break;
      ...
      case 4: // no object selected
        ...
        I18N.set(this.helpElem, "textContent",
          "design|tool.revolve.select_object");
        application.i18n.update(this.helpElem);
        this.removeWheel();
        break;
    }
