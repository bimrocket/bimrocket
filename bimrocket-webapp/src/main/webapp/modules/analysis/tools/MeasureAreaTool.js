...
class MeasureAreaTool extends Tool
{
  constructor(application, options)
  {
    ...
    this.label = "analysis|tool.measure_area.label";
    this.className = "measure-area";
    this.iconName = "analysis|measure-area";
    ...
    const url = $url("../assets/textures/area.png", import.meta);
  ...
  createPanel()
  {
    ...
    I18N.set(this.helpElem, "textContent", "analysis|tool.measure_area.help");
