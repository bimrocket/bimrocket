...
export const translations =
{
  ...
  "tool.model_validation.label" : "Model View",
  "tool.model_validation.help"  : "Model Views — paint model elements by property values",
  ...
  "mv.title.file_browser"  : "Model View Files",
  ...
  "mv.btn.add_rule"           : "+ Rule (legacy)",
  "mv.btn.add_stylization"    : "+ Rule",
  "mv.btn.add_value"          : "+ Value",
  "mv.tree.add_condition"     : "+ Condition",
  "mv.tree.add_group"         : "+ Sub-condition",
  "mv.tree.remove_condition"  : "Remove condition",
  "mv.tree.remove_group"      : "Remove sub-condition",
  "mv.tree.type.and"          : "AND",
  "mv.tree.type.or"           : "OR",
  "mv.tree.type.not"          : "NOT",
  "mv.styl.if"                : "IF",
  "mv.styl.then"              : "THEN",
  "mv.legend.rule_label"      : "Rule",
  ...
  "mv.placeholder.rule_name"    : "Rule name (optional)...",
  ...
  "mv.filter.gt"           : "> Greater than",
  "mv.filter.gte"          : ">= Greater or equal",
  "mv.filter.lt"           : "< Less than",
  "mv.filter.lte"          : "<= Less or equal",
  ...
  "mv.action.show"         : "Show",
  "mv.action.hide"         : "Hide",
  "mv.action.color"        : "Color",
  "mv.action.transparent"  : "Transparent",

  "mv.opacity.fixed"       : "Fixed",
  "mv.opacity.property"    : "Property",

  "mv.placeholder.pset"    : "Property set",
  "mv.placeholder.param"   : "Parameter",
  ...
  "mv.legend.filters"      : "Filters",
  "mv.legend.select_all_pack" : "Select all objects matching this rule",
  "mv.legend.no_value"     : "— (no value)",
  "mv.legend.no_match"     : "✗ No match",

  "mv.match.has_param"     : "has parameter",
  "mv.match.no_param"      : "no parameter",
  "mv.match.has_value"     : "has value",
  "mv.match.no_value"      : "no value",
  "mv.match.exact"         : "equals",
  "mv.match.contains"      : "contains",
  "mv.match.starts"        : "starts with",
  "mv.match.ends"          : "ends with",
  "mv.match.not_exact"     : "not equal to",
  "mv.match.not_contains"  : "does not contain",
  "mv.match.not_starts"    : "does not start with",
  "mv.match.not_ends"      : "does not end with",
  "mv.match.gt"            : ">",
  "mv.match.gte"           : ">=",
  "mv.match.lt"            : "<",
  "mv.match.lte"           : "<=",
  ...
  "mv.dialog.save_title"   : "Save Model View",
  ...
  "mv.action.save_here"    : "Save Model View here",
  "mv.toast.navigate_to_save" : "Navigate to the destination folder and right-click to save the Model View.",
  "mv.action.create"       : "Model View",
  "mv.action.edit"         : "Edit Model View",
  "mv.error.not_model_validation" : "This file was not created with the Model View assistant.",
};
