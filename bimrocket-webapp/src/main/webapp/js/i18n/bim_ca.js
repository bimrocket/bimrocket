...
export const translations =
{
  ...
  "tool.model_validation.label" : "Validació Visual de Models",
  "tool.model_validation.help"  : "Model Validations — pinta elements del model per valors de propietats",
  ...
  "mv.title.file_browser"  : "Arxius ModelValidation",
  ...
  "mv.dialog.save_title"   : "Desa la Model Validation",
  ...
  "mv.action.save_here"    : "Desa la Validació Visual aquí",
  "mv.toast.navigate_to_save" : "Navega a la carpeta de destí i fes clic dret per desar la Validació Visual.",
  "mv.action.create"       : "Crea Validació Visual de Models",
  "mv.action.edit"         : "Edita Validació Visual de Models",
  "mv.error.not_model_validation" : "Aquest fitxer no ha estat creat amb l'assistent de Validació Visual de Models.",
};
