...
import { toTrianglesDrawMode } from 'platform/utils/BufferGeometryUtils.js'; // bimrocket
...
class GLTFLoader extends Loader {
	...
	constructor( manager ) {
		...
		this.dracoLoader = new DRACOLoader().setDecoderPath('js/lib/draco/'); // bimrocket
