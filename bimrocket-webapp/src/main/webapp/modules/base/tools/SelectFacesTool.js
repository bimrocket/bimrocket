...
class SelectFacesTool extends Tool
{
  ...
  constructor(application, options)
  {
    ...
    this.label = "base|tool.select_faces.label";
    this.className = "select-faces";
    this.iconName = "base|select-faces";
  ...
  createPanel()
  {
    ...
    this.selectModeElem = Controls.addSelectField(this.panel.bodyElem,
      "select_faces_mode", "base|label.select_faces_mode",
      [[SelectFacesTool.SET_PLANE, "base|option.select_faces.select_plane"],
       [SelectFacesTool.ADD_FACES, "base|option.select_faces.add_faces"],
       [SelectFacesTool.REMOVE_FACES, "base|option.select_faces.remove_faces"]],
    ...
    this.angleInputElem = Controls.addNumberField(this.panel.bodyElem,
      "select_faces_angle", "base|label.select_faces_angle", 20);
    ...
    this.depthInputElem = Controls.addNumberField(this.panel.bodyElem,
      "select_faces_depth", "base|label.select_faces_depth", 0.5);
