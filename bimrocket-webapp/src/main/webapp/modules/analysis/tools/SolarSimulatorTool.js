...
import { BIMUtils } from "platform/utils/BIMUtils.js";
...
class SolarSimulatorTool extends Tool
{
  constructor(application, options)
  {
    ...
    this.label = "analysis|tool.solar_simulator.label";
    this.className = "solar-simulator";
    this.iconName = "analysis|solar-simulator";
  ...
  createPanel()
  {
    ...
    this.lonElem = Controls.addNumberField(this.panel.bodyElem,
      "solar_lon", "analysis|label.longitude", lon);
    ...
    this.latElem = Controls.addNumberField(this.panel.bodyElem,
      "solar_lon", "analysis|label.latitude", lat);
    ...
    this.dateElem = Controls.addDateField(this.panel.bodyElem,
      "solar_date", "analysis|label.date", isoDate);
    ...
    this.shadowsCheckBox = Controls.addCheckBoxField(this.panel.bodyElem,
      "solar_cast_shadows", "analysis|tool.solar_simulator.cast_shadows", false,
    ...
    this.intensityCheckBox = Controls.addCheckBoxField(this.panel.bodyElem,
      "solar_intensity", "analysis|tool.solar_simulator.adjust_intensity", true,
      "flex align-items-center p-1");
    ...
    this.maxLengthElem = Controls.addNumberField(this.exposureElem,
      "solar_max_length", "analysis|label.max_length", 0.1);
    ...
    I18N.set(this.maxLengthElem.previousSibling, "title",
      "analysis|tool.solar_simulator.max_length_info");

    this.maxAreaElem = Controls.addNumberField(this.exposureElem,
      "solar_max_area", "analysis|label.max_area", 0.0001);
    this.maxAreaElem.step = 0.0001;
    this.maxAreaElem.min = 0;
    this.maxAreaElem.style.margin = "4px";
    this.maxAreaElem.style.width = "80px";
    I18N.set(this.maxAreaElem.previousSibling, "title",
      "analysis|tool.solar_simulator.max_area_info");

    this.startExposureButton = Controls.addButton(this.exposureElem,
      "solar_exposure", "analysis|button.exposure", () => this.startExposure());
  ...
  startExposure()
  {
    ...
    {
      MessageDialog.create("analysis|tool.solar_simulator.label",
       "analysis|message.solar_simulator_select_faces")
       .setClassName("info")
