...
import { SolidBuilder } from "platform/builders/SolidBuilder.js";
...
class DecomposeTool extends Tool
{
  constructor(application, options)
  {
    super(application);
    this.name = "decompose";
    this.label = "design|tool.decompose.label";
    this.help = "design|tool.decompose.help";
    this.className = "decompose";
    this.iconName = "design|decompose";
