...
class PlaceTool extends Tool
{
  ...
  constructor(application, options)
  {
    super(application);
    this.name = "place";
    this.label = "design|tool.place.label";
    this.help = "design|tool.place.help";
    this.className = "place";
    this.iconName = "design|place";
  ...
  createPanel()
  {
    this.panel = this.application.createToolPanel(this)
      .setClassName("panel-place")
      .setDefaultHeight(140)
      .setDefaultMobileHeight(100)
    ...
    I18N.set(this.helpElem, "textContent", this.help);

    this.modeElem = Controls.addSelectField(this.panel.bodyElem,
      "place_mode", "design|label.place_mode",
