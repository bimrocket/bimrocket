...
export function activate(application)
{
  ...
  const perspectiveTool = new CameraProjectionTool(application,
    {
      name: "perspective",
      label: "base|tool.perspective.label",
      type: "perspective",
      keyShortcut: "Shift+P",
      iconName: "base|perspective"
    });
  const orthographicTool = new CameraProjectionTool(application,
    {
      name: "orthographic",
      label: "base|tool.orthographic.label",
      type: "orthographic", keyShortcut: "Shift+O",
      iconName: "base|orthographic"
    });
  ...
  if (outliner)
  {
    ...
    outlinerMenu.addSeparator();
    outlinerMenu.addMenuItem(activateCameraTool);
    outlinerMenu.addSeparator();
