...
class OpenLocalTool extends Tool
{
  constructor(application, options)
  {
    super(application);
    this.name = "openlocal";
    this.label = "base|tool.open_local.label";
    this.help = "base|tool.open_local.help";
    this.className = "open-local";
    this.iconName = "base|open-local";
  ...
  createDropIndicator()
  {
    ...
    I18N.set(dropIndicator, "textContent", "base|tool.open_local.drop_here");
  ...
  registerDragAndDrop()
  {
    ...
    dragElement.addEventListener("dragover", event =>
    {
      ...
      {
        container.classList.add("file-drop");
        container.style.cursor = "copy";
        event.dataTransfer.dropEffect = "copy";
      }
      else
      {
        container.classList.remove("file-drop");
